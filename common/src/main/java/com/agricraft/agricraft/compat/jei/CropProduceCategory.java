...
public class CropProduceCategory implements IRecipeCategory<AgriPlant> {
	...
	public static final IDrawable ICON = AgriCraftJeiPlugin.createDrawable(ResourceLocation.fromNamespaceAndPath(AgriApi.MOD_ID, "textures/item/debugger.png"), 0, 0, 16, 16, 16, 16);
